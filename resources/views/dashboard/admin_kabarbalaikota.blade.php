    ...
    <div class="kota-terkini">
        ...
        <div class="berita-baru">
            ...
            <div class="action-button mt-3">
                ...
                <a href="/admin/berita/category/kabarbalaikota">
                    <button type="button" class="btn btn-primary">Lihat Semua</button>
                </a>
                <a href="/admin/komentar/category/kabarbalaikota"><button type="button" class="btn btn-warning">Lihat Semua Komentar</button></a>
            </div>
        </div>
    </div>
</div>
