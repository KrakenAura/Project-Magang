    ...
    <div class="kota-terkini">
        ...
        <div class="berita-baru">
                ...
                <div class="berita-item">
                    ...
                    <div class="berita-content">
                        ...
                        <div class="berita-text">
                            <!-- Berita text goes here if needed -->
                        </div>
                        <p class="berita-date">{{ $berita->created_at->format('d F, Y') }}</p>
                        <div class="berita-actions">
                            <a href="{{ route('admin.kotaterkini_edit', $berita->id) }}"><button class="btn btn-primary">Edit</button></a>
            ...
            <div class="action-button mt-3">
                ...
                <a href="/admin/berita/category/kotaterkini">
                    <button type="button" class="btn btn-primary">Lihat Semua</button>
                </a>
                <a href="/admin/komentar/category/kotaterkini"><button type="button" class="btn btn-warning">Lihat Semua Komentar</button></a>
            </div>
        </div>
    </div>
</div>
